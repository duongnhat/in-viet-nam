...
@section('content')
    <div class="card container border bg-light px-0">
        <h3 class="card-header text-center bg-secondary text-light text-uppercase">Đăng bài sản phẩm</h3>
        <div class="card-body">
...
{{--                        @endforeach--}}
                ...
                <button type="button" onclick="toPostStatusToPageFacebook()" class="btn btn-primary">Đăng</button>
